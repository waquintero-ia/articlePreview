...
const Share = ({handleClick, share}) =>{
  ...
  return(
    <>
      <button className={`w-8 h-8 flex justify-center items-center bg-blue-300 rounded-full ${share && 'md:bg-blue-800 md:text-white'}`} onClick={handleClick} aria-label='share'>
